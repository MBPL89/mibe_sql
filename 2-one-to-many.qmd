...
databases:
  ...
  - name: ns
    path: "https://raw.githubusercontent.com/MBPL89/dbs/refs/heads/main/natstock.sql"
---
...
This approach creates what's known as an "inner join" - it only shows data where there are matches between both tables.
We will explore more powerful ways to join tables in our next session.
...
2. **Table subqueries**: Return multiple rows and columns.
